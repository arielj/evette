		...
		if len(self.htmllist) != 0:
			...
			if str(self.htmllist[n][4]) != "None":
				...
				if daypivot == 0:
					...
					daypivot = "<font size=2 color=green><b> TODAY</b></font>"
					
				elif daypivot > 0:
					
					if daypivot == 1:
						daypivot = "<font size=2 color=green> in " + str(daypivot) + " day</font>"
					else:
						daypivot = "<font size=2 color=green> in " + str(daypivot) + " days</font>"
					...
					if daypivot == 1:
						daypivot = "<font size=2 color=red> " + str(daypivot) + " day ago</font>"
					else:
						daypivot = "<font size=2 color=red> " + str(daypivot) + " days ago</font>"
			...
			return "<table width=100% cellpadding=0 cellspacing=5><tr><td valign=top><font size=2>Given:<br></font><font color=red>" + date + "</font></td><td valign=top width=100%><font color=blue>" + name + "<br></font><font size=2>Batch: " + batchno + "</font></td><td valign=top><font size=2>Next due:<br></font>" + nextdue + "<br>" + daypivot + "</td></tr></table>"
